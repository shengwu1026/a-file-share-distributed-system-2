...
public class Resource implements Cloneable {
    ...
    /**
     * The method is to check whether the resource has all the fields that required.
    ...
    /**
     * The method is to parse a resource object to a json object.
     * @param resource
     * @return jsonObject
     */
    ...
    /**
     * The method is to parse a json object to a resource object.
     * @param resourceObject
     * @return resource
     */
    ...
    /**
     * The method is to check whether a resource is in the record.
     * @param obj
     * @return true if PK (owner, channel, uri) is the same
     *         false if not
     */
    @Override
    ...
    /**
     * The method is to clone the current resource.
